...
export class AuthService {
    isIframe$ = new BehaviorSubject<boolean>(false);
    ...
    init(): void {
        this.isIframe$.next(window !== window.parent && !window.opener); // Remove this line to use Angular Universal
    ...
    setLoginDisplay() {
        ...
        this.loginDisplay$.next(loggedIn);
